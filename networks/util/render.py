...
import networks.util.render_utils as util
from networks.util.imutils import blend_rgb_norm
# from networks.util.mesh_util import get_visibility
...
class Render:
    ...
    def init_renderer(self, camera, type="mesh", bg="white"):
    ...
    def get_image(self, cam_type="four", type="rgb", bg="white"):
