...
if os.path.exists('./cuda/voxelize_cuda.cu') and os.path.exists('./cuda/voxelize_cuda.cpp'):
    voxelize_cuda = load(
        ...
        verbose=True)
elif os.path.exists('/media/gpu/dataset_SSD/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cu') and \
    os.path.exists('/media/gpu/dataset_SSD/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cpp'):
    voxelize_cuda = load(
        name='voxelize_cuda',
        sources=['/media/gpu/dataset_SSD/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cpp',
                 '/media/gpu/dataset_SSD/code/PaMIR-main/networks/neural_voxelization_layer/cuda/voxelize_cuda.cu'],
        extra_ldflags=['-L/usr/local/cuda/targets/x86_64-linux/lib'],
        verbose=True)
else:
