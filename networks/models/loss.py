...
# def chamfer_distance(s1, s2,s1_face,s2_face, w1=1., w2=1.,device):
#     """
#     :param s1: B x N x 3
#     :param s2: B x M x 3
...
#     tris = s1[s1_face]
#     p2s_y = point_face_distance(
#         s2[0], torch.tensor([0]).to(device), tris, torch.tensor([0]).to(device), s2.shape[1],
#         0.005).sqrt().mean() * 100
#
#     tris = s2[s2_face].to(device)
#     p2s_x = point_face_distance(
#         s1[0], torch.tensor([0]).to(device), tris, torch.tensor([0]).to(device), s1.shape[1],
#         0.005).sqrt().mean() * 100
#
#     chamfer_dis = (p2s_x + p2s_y) / 2
#
