...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--save_latest_freq', type=int, default=360, help='frequency of saving the latest results')
        ...
        self.parser.add_argument('--niter_decay', type=int, default=48, help='# of iter to linearly decay learning rate to zero')
