...
CUBE_PARTS_FILE = '/media/gpu/dataset_SSD/code/PaMIR-main/networks/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = '/media/gpu/dataset_SSD/code/PaMIR-main/networks/data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = '/media/gpu/dataset_SSD/code/PaMIR-main/networks/data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = '/media/gpu/dataset_SSD/code/PaMIR-main/networks/data/vertex_texture.npy'
LSP_REGRESSOR_EVAL = '/media/gpu/dataset_SSD/code/PaMIR-main/networks/data/smpl2lsp_j_regressor_nt_v2.npy'
SMPL_FILE = '/media/gpu/dataset_SSD/code/PaMIR-main/networks/data/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl'
